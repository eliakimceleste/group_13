...
def generate_image():
    ...
    root.update_idletasks()  # Mise à jour de l'interface pour afficher le spinner
    ...
    def generate_image_thread():
        try:
            ...
            # Télechargement de l'img depuis l'URL
...
def update_image(image):
    ...
    try:
        ...
        description_entry.delete(0, tk.END)  # Reinitialiser l'entrée de texte
    except Exception as e:
...
if __name__ == '__main__':
    ...
    # Zone d'affichage pour l'img générée
